frappe.ui.form.on('Case', {
    onload: function (listview) {
        ...
        listview.filter_area.add([[listview.doctype, 'archive_status', '!=', 'Archived']]);
        listview.refresh();
    },
                ...
                frappe.confirm(
                    ...
                    function () {
                        frappe.call({
                            ...
                            callback: function (response) {
                                if (!response.exc) {
                                    frappe.msgprint('This document has been unarchived successfully.');
                                    frm.reload_doc();
                                } else {
                                    frappe.msgprint('There was an issue unarchiving this document.');
                                }
                            }
                        });
                    },
                ...
                frappe.confirm(
                    ...
                    function () {
                        frappe.call({
                            ...
                            callback: function (response) {
                                if (!response.exc) {
                                    frappe.msgprint('This document has been archived successfully.');
                                    frm.reload_doc();
                                } else {
                                    frappe.msgprint('There was an issue archiving this document.');
                                }
                            }
                        });
                    },
